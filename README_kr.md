...
`x1zzLang`은 오픈소스 프로젝트로서 모든 형태의 관심과 피드백을 환영합니다. 

단, 현재 **2026년 제8회 한국코드페어(Korea-CodeFair) SW공모전 출품 및 대회 규정(순수 자가 구현 검증 및 연구 윤리) 준수**를 위해, 대회 본선이 종료되는 **2026년 10월말까지 Pull Request(코드 기여) 접수를 일시적으로 제한(Hold)**합니다. 외부 기여 코드가 혼선되는 것을 방지하고 프로젝트의 무결성을 증명하기 위한 조치이오니 양해 부탁드립니다.

* **Issue (제안 및 버그 제보):** 🟢 언제나 환영합니다! 기능 제안, 버그 리포트, 아이디어는 Issue를 통해 적극적으로 남겨주세요. 개발 과정에 큰 도움이 됩니다.
* **Pull Request (코드 반영):** 🟡 2026년 10월 본선 대회 종료 이후부터 다시 Open될 예정입니다.

`x1zzLang`에 보여주신 관심에 깊이 감사드립니다.
