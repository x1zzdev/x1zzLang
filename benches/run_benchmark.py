...
<div class="page">
  ...
  <p style="font-size:13px;color:#334155;margin-bottom:12px">
    ...
    <code>.collect()</code>.
    Right: <strong>Python Pandas</strong> eager-evaluation baseline
    (<code>pandas_pipeline.py</code>).
  </p>
